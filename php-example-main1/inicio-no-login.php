  ...
  <?php
    ...
    <div class="tutorial">
      <div class="pasos">
        ...
        <p>
            Unz vez con la sesion iniciada, selecciona la opcion de "Generar Reporte", la cual se encuentra en el menu de navegacion.
        </p>
        <br>
      </div>
      <div class="pasos">
        ...
        <p>
            Una vez en la opcion de "Generar Reporte", lo siguiente es llenar el formulario de reportes, y seleccionando la ubicacion del pronlema a reportar en el mapa y subir una foto de prueba de forma opcional.
        </p>
        <br>
        </div>
      <div class="pasos">
          ...
          <p>
            Una vez llenado el formulario, seleccionar el boton "Reportar", y una vez enviado el reporte, se le notificara al administrador del sistema para que actualice el si.
          </p>
          <br>
      </div>
    </div>
